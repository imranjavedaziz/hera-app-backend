...
Route::group(['prefix' => 'v1', 'namespace' => 'Api'], function () {
    ...
    Route::get('forward-request', [PaymentController::class, 'forwardRequest']);
    Route::get('make-payment', [PaymentController::class, 'makePayment']);
    Route::get('make-donor-payment', [PaymentController::class, 'makeDonorPayment']);
    Route::get('transaction-result', [PaymentController::class, 'pollTransactionResult']);
    Route::get('donor-transaction-result', [PaymentController::class, 'pollDonorTransactionResult']);
    ...
    Route::group([MIDDLEWARE => ['jwt.verify', 'CheckUserAccountStatus']], function () {
        ...
        Route::middleware([EnsureParentsToBeTokenIsValid::class])->group(function () {
            ...
            Route::post('create-subscription-payment-page', [SubscriptionController::class, 'createSubscriptionPaymentPage']);
            ...
            Route::get('create-donor-payment-page/{paymentRequestId}', [PaymentController::class, 'createDonorPaymentPage']);
        });
