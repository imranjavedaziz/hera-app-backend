...
class CreateAccountDeactiveReasonsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('account_deactive_reasons', function (Blueprint $table) {
            $table->id();
            $table->string(NAME);
    ...
    {
        Schema::dropIfExists('account_deactive_reasons');
    }
}
