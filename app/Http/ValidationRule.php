...
class ValidationRule
{
    ...
    public const IMAGE =[BAIL, REQUIRED_WITHOUT_VIDEO, SOMETIMES, NULLABLE, IMAGE_MIMES, MAX_LIMIT_FIVE_THOUSAND];
    public const VIDEO =[BAIL, REQUIRED_WITHOUT_IMAGE, SOMETIMES, NULLABLE, VIDEO_MIMES, MAX_LIMIT_FIVE_THOUSAND];
