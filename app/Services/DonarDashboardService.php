...
{
    public function getPtbProfileCard()
    {
        return User::select(ID,FIRST_NAME,MIDDLE_NAME,LAST_NAME,ROLE_ID,COUNTRY_CODE,PHONE_NO,EMAIL, PROFILE_PIC,DOB,RECENT_ACTIVITY)->where(ROLE_ID, PARENTS_TO_BE)
