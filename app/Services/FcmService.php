...
class FcmService
{
    ...
    public function sendPushNotification($input, $sender_id)
    {
        ...
        if(!empty($userDevice)) {
            ...
            $chatArray["read"] = (int)ZERO;
            $chatArray["feedback_status"] = !empty($feedback) ? (int)$feedback->like : NULL;
            $chatArray["recieverId"] = (int)$sender_id;
            ...
            $chatArray["recieverSubscription"] = (int)SubscriptionService::getSubscriptionStatus($sender_user->id);
            $chatArray["senderId"] = (int)$receiver_user->id;
            ...
            $chatArray["senderSubscription"] = (int)SubscriptionService::getSubscriptionStatus($receiver_user->id);
            $chatArray["status_id"] = (int)ACTIVE;
            $chatArray[MATCH_REQUEST] = $profile_match;
            $chatArray["time"] = (int)time();
            $chatArray["type"] = "Text";
