            ...
            <table
                ...
                <tr>
                    <td style="font-size: 16px; line-height: 25px; padding: 0 40px 23px 40px;">
                        Your HERA Family Planning account has been deactivated by admin.
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 16px; line-height: 25px; padding: 0 40px 23px 40px;">
                       You cannot access your account until it gets reactivated by admin. Until then, your profile will be shown as "Inactive User" to your existing connections & your profile will not appear in searches.
                    </td>
                </tr>
                <tr>
