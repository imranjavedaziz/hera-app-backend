...
<tr>
    <td>
        <table
            ...
            <tr>
                <td style="font-size: 16px; line-height: 22px; padding: 0 40px 27px 40px;">You made payment to Surrogate Mother #SM0282 & the transaction is now under process. You will receive a confirmation once the amount is successfully received by the Surrogate Mother.
                </td>
            </tr>
            <tr>
                <td style="padding: 0 40px 30px 40px;">
                    <table style="width: 100%;border-collapse: collapse;" aria-describedby="Account Verify">
                        ...
                        <tr>
                            <td style="font-weight: normal; font-size: 14px;border-top: 2px solid rgb(228 226 216);border-bottom: 2px solid rgb(228 226 216);padding: 20px 0;">
                                Total Amount:
                            </td>
                            <td style="font-weight: bold; font-size: 14px;text-align: right;border-top: 2px solid rgb(228 226 216);border-bottom: 2px solid rgb(228 226 216);padding: 20px 0;">
                                $309.00
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td style="font-size: 16px; line-height: 22px; padding: 0 40px 23px 40px; font-style: italic;color: #000;">
                    Your transaction ID is 02839002.
                </td>
            </tr>
            <tr>
