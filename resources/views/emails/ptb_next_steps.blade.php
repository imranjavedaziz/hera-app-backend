    ...
    <td>
        <table
            ...
            <tr>
                ...
                Thank you for your confirmation to go ahead with the {{$donar->role->name}} #{{$donar['username']}} & start your journey with them. We have sent an email to the {{$donar->role->name}} about your confirmation.
                </td>
            </tr>
            <tr>
