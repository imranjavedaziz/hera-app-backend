            ...
            <table
                ...
                <tr>
                    <td style="font-size: 16px; line-height: 25px; padding: 0 40px 23px 40px;">
                        Your HERA Family Planning account has been permanently deleted & cannot be restored.
                    </td>
                </tr>
                <tr>
                    <td style="font-size: 16px; line-height: 25px; padding: 0 40px 23px 40px;">
                        We hope you enjoyed you time on HERA and are looking forward to welcoming you back.
                    </td>
                </tr>
                <tr>
