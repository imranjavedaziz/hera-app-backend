<div class="btn-group user-btn-group ms-auto">
    <button type="button" class="btn btn-secondary dropdown-toggle dropdown-bg-none" data-bs-toggle="dropdown" aria-expanded="false"><span>
        <img src="/assets/images/svg/user-icon.svg" alt="user-logo" /></span></button>
