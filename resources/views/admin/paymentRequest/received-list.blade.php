...
<div class="main-right-wrapper">
    <div class="dashboard-container">
        ...
        <ul class="nav nav-tabs">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="/admin/payment-requests/received">Received</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="/admin/payment-requests/completed">Completed</a>
            </li>
            <li class="nav-item">
        ...
        <h1 class="section-title">Received Payment Requests (<span>{{$paymentRequestsData->total()}}</span>)</h1>
        @else
        <!-- For no Pending Payment Request found -->
        <div class="no-users">No Received Payment Requests Yet</div>
        @endif
    </div>
    @if ($paymentRequestsData->count() > 0)
