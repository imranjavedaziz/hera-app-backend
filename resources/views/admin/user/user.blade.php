                ...
                @if (!empty($userData) && $userData->count() > 0)
                    @foreach($userData as $user)
                        ...
                        <div class="table-row">
                            ...
                            <div class="td @if($user->status_id == 1) d-block @else d-none @endif" id="active-user{{$user->id}}">Active</div>
                            <div class="td text-danger @if($user->status_id == 1) d-none @else d-block @endif" id="inactive-user{{$user->id}}">Inactive
                                <span>@if($user->deactivated_by == 1) (By Admin) @elseif($user->deactivated_by == 2) (By User) @endif</span>
                            </div>
                            <div class="td">
